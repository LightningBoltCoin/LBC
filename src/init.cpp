...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/lightningboltcoin-project/lightningboltcoin>";
    const std::string URL_WEBSITE = "<https://lightningboltcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Lightningboltcoin version %s\n", FormatFullVersion());
}
