...
{
    const char* pszTimestamp = "25/MAY/2021 I am learning blockchain";
    const CScript genesisOutputScript = CScript() << ParseHex("166684710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1621953624, 2001308518, 0x1e0ffff0, 1, 66 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x706a7e69236262da0d6bfb66341c86ba356abe330ad107701cc61bc0f62e82c1"));
        assert(genesis.hashMerkleRoot == uint256S("0x929fd50fcbd917e9230950a90f4594ae34656245a21f2c07db950cc217d7b165"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("52.150.8.80", "52.150.8.80", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("lightningboltcointools.com", "dnsseed.lightningboltcointools.com"));
        //vSeeds.push_back(CDNSSeedData("lightningboltcoinpool.org", "dnsseed.lightningboltcoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x706a7e69236262da0d6bfb66341c86ba356abe330ad107701cc61bc0f62e82c1"))
        ...
        chainTxData = ChainTxData{
            ...
            1621953624, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1621953624, 198977, 0x1e0ffff0, 1, 66 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb796d0f54b557b65784f33f7bb7d22130c7864664f0bb0e7a9474a982dcab629"));
        assert(genesis.hashMerkleRoot == uint256S("0x929fd50fcbd917e9230950a90f4594ae34656245a21f2c07db950cc217d7b165"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("52.150.8.80", "52.150.8.80"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.lightningboltcoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xb796d0f54b557b65784f33f7bb7d22130c7864664f0bb0e7a9474a982dcab629")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1621953624, 0, 0x207fffff, 1, 66 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xfc0a859cd72d4969382ea4d285738345d9a26e178e918c688eed54a8eda6ac9f"));
        assert(genesis.hashMerkleRoot == uint256S("0x929fd50fcbd917e9230950a90f4594ae34656245a21f2c07db950cc217d7b165"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xfc0a859cd72d4969382ea4d285738345d9a26e178e918c688eed54a8eda6ac9f"))
        };
