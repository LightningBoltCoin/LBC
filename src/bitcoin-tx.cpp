...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s lightningboltcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lightningboltcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lightningboltcoin transaction") + "\n" +
              "  lightningboltcoin-tx [options] -create [commands]   " + _("Create hex-encoded lightningboltcoin transaction") + "\n" +
              "\n";
